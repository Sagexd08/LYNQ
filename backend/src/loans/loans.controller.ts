...
export class LoansController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Loan created with risk assessment',
  })
  @ApiResponse({
    status: 400,
    description: 'Loan rejected or validation error',
  })
  async create(
  ...
  @Post(':id/activate')
  @ApiOperation({
    summary: 'Activate a pending loan with collateral verification',
  })
