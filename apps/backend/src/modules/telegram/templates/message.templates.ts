...
├ Due Date: ${data.dueDate ? escapeMarkdown(formatDate(data.dueDate)) : 'N/A'}
└ Tx: [View on Explorer](https://explorer.mantle.xyz/tx/${data.transactionHash})
...
[Repay Now](https://lynq.finance/loans/${data.loanId})
`,
...
[Manage Position](https://lynq.finance/loans/${data.loanId})
`,
...
[Add Collateral Now](https://lynq.finance/loans/${data.loanId})
`,
...
[View Full Report](https://lynq.finance/analytics)
`;
    },
...
[View Vouches](https://lynq.finance/vouches)
`,
...
[Refinance Now](https://lynq.finance/loans/${data.loanId}/refinance)
`,
...
[Open Dashboard](https://lynq.finance/dashboard)
`,
...
[View Details](https://lynq.finance/dashboard)
`,
